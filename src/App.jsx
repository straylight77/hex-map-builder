...
import { Hand, Eraser, Plus, Minus, RotateCcw, ChevronRight, ChevronLeft, Landmark, Route, Waves } from 'lucide-react';
  ...
  return (
    <div className="flex flex-col h-screen bg-gray-50">
      ...
      <div className="flex flex-1 overflow-hidden relative">
        ...
        {/* Canvas - base layer behind everything */}
              ...
              <div className="p-2 border-b border-gray-300 flex justify-between items-center">
                ...
                <div className="flex gap-1">
                  <button 
                    ...
                    className={`p-2 rounded ${libraryColumns >= 3 ? 'text-gray-300' : 'hover:bg-gray-100'}`}
                    title="Expand Library"
                  >
                    <ChevronLeft size={18} />
                  </button>
                  <button 
                    onClick={() => setLibraryColumns(Math.max(1, libraryColumns - 1))}
                    disabled={libraryColumns <= 1}
                    className={`p-2 rounded ${libraryColumns <= 1 ? 'text-gray-300' : 'hover:bg-gray-100'}`}
